...
def sort_FS(self, mode: str):
    ...
    for fileName in fs_table.keys():
        ...
        try:
            ...
            shutil.move(
                fs_table[fileName]["old_path"][3:] + "/" + fileName,
    ...
    for fileName in fs_table.keys():
        try:
            old_path = fs_table[fileName]["old_path"][3:]
...
def sort_FS2(
    ...
    for fileName in fs_table.keys():
        ...
        try:
            ...
            print('Old', fs_table[fileName]["old_path"][3:])
            print('new_path', fs_table[fileName]["new_path"])
            shutil.move(
                fs_table[fileName]["old_path"][3:],
                fs_table[fileName]["new_path"],
            )
...
def sort_FS3(
    ...
    for fileName in fs_table.keys():
        ...
        try:
            ...
            print("old path", fs_table[fileName]["old_path"][3:])
            print("old new_path", fs_table[fileName]["new_path"])
            shutil.move(
                fs_table[fileName]["old_path"][3:],
                fs_table[fileName]["new_path"],
            )
